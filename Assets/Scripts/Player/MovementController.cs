...
public class MovementController : MonoBehaviour
{
    ...
    public AudioSource walkingSound; // Reference to the AudioSource component
    ...
    void Start()
    {
        ...
        walkingSound = GetComponent<AudioSource>(); // Assign the AudioSource component

        // Configure the walking sound settings
    ...
    private void AnimateMovement()
    {
        ...
        // Play walking sound when the character is moving
